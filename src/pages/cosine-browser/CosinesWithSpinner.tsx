...
interface CosinesWithSpinnerProps {
    doc: string
}
...
export const CosinesWithSpinner = ({doc}: CosinesWithSpinnerProps) => {
    ...
    if (loading) {
        return <ClimbingBoxLoader color="blue" css={override} loading={loading} size={100}/>
